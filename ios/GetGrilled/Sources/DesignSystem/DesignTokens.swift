...
enum MotionTokens {
    ...
    /// Takes the caller's own `\.accessibilityReduceMotion` reading so SwiftUI re-evaluates
    /// this when the setting changes live, instead of a static UIKit global no view observes.
